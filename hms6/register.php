      ...
      <form method="post" action="#" enctype="multipart/form-data" id="registrationForm">
        ...
        <div class="row">
          ...
          <div class="col-md-6 mb-3">
            ...
            <input type="number" class="form-control" name="experience" id="experience" placeholder="Enter your number"
              required />
          </div>
        </div>
        <div class="row">
        ...
        <div class="row">
          <div class="col-md-6 mb-3">
            ...
            <input type="text" class="form-control" name="username" id="username" oninput="this.value=this.value.replace(/[^a-z\W]/g,'')" minlength=10 maxlength=10 size=10 placeholder="Enter your Username"
              required />
          </div>
          <div class="col-md-6 mb-3">
