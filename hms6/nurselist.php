    ...
    <div class="container" style="margin-top: 20px;">
                    <div class="row table-responsive">
                      ...
                      <div class="col-sm-3">
                       ...
                       <div class="col-sm-1">
                       <a href="register.php" class="btn btn-primary text-decoration-none" style="float:right;">ADD</a>
                       </div>
                        ...
                        <table class="table table-bordered" id="mytable">
                            ...
                            <?php
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:center;"><a href="profilenurse.php?id=<?php echo $row['id']; ?>" style="text-align: center;">View</a></td>
