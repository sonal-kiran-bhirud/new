    ...
    if($res){
        ...
        $(document).ready(function(){
            Swal.fire({
                ...
                window.history.go(-2); // Redirect to view.php after user clicks OK
            });
        });
    </script>';
    }
