...
<div class="row">
    <div class="form-group col-md-4">
        ...
        <input type="number" class="form-control" placeholder="Height" name="height" id="height"required >
    </div>


    <div class="form-group col-md-4">
        <label for="weight">Weight</label>
        <input type="number" class="form-control" placeholder="Weight" name="weight" id="weight"required >
    </div>
...
<option value="O-">O-</option>
    ...
    <div class="form-group col-md-4">
        ...
        <small id="indateValidation" style="color: red"></small>
...
<div class="row">
    <div class="form-group col-md-4">
        ...
        <small id="outdateValidation" style="color: red"></small>
      </div>
 
   
        <div class="form-group col-md-4">
            <label for="roomno">Room No</label>
            <input type="number" class="form-control" placeholder="Enter Room Number" name="roomno" id="roomno"required>
        </div>
...
<input type="number" class="form-control" id="insuranceid" name="insuranceid" placeholder="Insurance ID">
</div>
</div><br>
<div class="row">
...
<input type="text" class="form-control" id="relation" name="relation" placeholder="Relation">
    ...
    <div style="text-align:center">
        <button type="submit" name="submit"  id="newbtn" class="btn btn-primary">Submit</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <button type="reset" name="reset"  id="newbtn" class="btn btn-dark">Reset</button>
        </div>
<div>
</div>
                </div>
...
//   }
// });
//Validations for inout

document.addEventListener("DOMContentLoaded", function() {
var outdateInput = document.getElementById("outdate");
var indateInput = document.getElementById("indate");
var outdateValidation = document.getElementById("outdateValidation");
var indateValidation = document.getElementById("indateValidation");

outdateInput.addEventListener("input", function(event) {
...
if (outdate <= indate) {
console.log("Inside");
outdateValidation.textContent = "Outdate must be after Indate.";
} else {
outdateValidation.textContent = "";
}
});
